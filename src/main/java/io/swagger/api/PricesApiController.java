...
public class PricesApiController implements PricesApi {
    ...
    public ResponseEntity<PriceResponse> pricesGet(@NotNull @Parameter(in = ParameterIn.QUERY, description = "Product ID" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "productId", required = true) Integer productId
...
,@NotNull @Parameter(in = ParameterIn.QUERY, description = "Application date and time in ISO-8601 format" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "applicationDate", required = true) OffsetDateTime applicationDate
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<PriceResponse>(objectMapper.readValue("{\n  \"productId\" : 0,\n  \"endDate\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"price\" : 5.962133916683182,\n  \"brandId\" : 6,\n  \"currency\" : \"currency\",\n  \"startDate\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"priceList\" : 1\n}", PriceResponse.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
                return new ResponseEntity<PriceResponse>(HttpStatus.INTERNAL_SERVER_ERROR);
            }
        }

        return new ResponseEntity<PriceResponse>(HttpStatus.NOT_IMPLEMENTED);
    }
